...
function Notification({ notification }) {
	return (
		<div className="relative">
			...
			<div className="absolute right-1 sm:right-4 top-10 sm:top-8 w-[33px] h-[31px] rounded-xl bg-[#2E37A40D] hover:bg-[#2E37A41D] flex items-center justify-center cursor-pointer">
